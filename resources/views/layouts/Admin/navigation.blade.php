<nav x-data="{ open: false }" class="bg-red-900 border-b border-gray-200 shadow-sm font-[serif] text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20 items-center">
            ...
            <!-- Desktop Navigation -->
            <div class="hidden sm:flex space-x-8 items-center text-lg">
                ...
                <x-nav-link :href="route('admin.schedule-form')" class="text-white hover:text-yellow-300 no-underline hover:no-underline transition">
                    {{ __('Add Schedule') }}
                </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden bg-red-900 text-white shadow-md p-4">
        ...
        <x-responsive-nav-link :href="route('admin.schedule-form')">
            {{ __('Book Schedule') }}
        </x-responsive-nav-link>
